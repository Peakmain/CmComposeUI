package com.peakmain.cmp_compose.ui.banner
...
import androidx.compose.ui.unit.dp
import com.peakmain.cmp_compose.utils.getScreenHeightPx
...
fun <T> PkHorizontalBanner(
    ...
    HorizontalPager(pagerState,
        ...
        //pageIndex 是用户操作的pagerIndex
        content(currentSelectedIndex,
            lists[if (pageIndex < lists.size) pageIndex else 0])
    }
}
